...
function TxSpinner({ size = "2em", className = "w-full items-center", ...props }: TxSpinnerProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} role="status" aria-label="Loading..." className={twMerge("animate-spin text-current", className)} {...props}>
      <path
        fill="currentColor"
